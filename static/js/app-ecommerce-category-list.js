        ...
        ((o = s.DataTable({
          ...
          columnDefs: [
            ...
            },
            {
              ...
              render: function (e, t, a, o) {
                var s = a.categories,
                  ...
                  l = a.id;
                return (
                  '<div class="d-flex align-items-center"><div class="avatar-wrapper me-2 rounded-2 bg-label-secondary"><div class="avatar">' +
                  (n
                    ? '<img src="' +
                      assetsPath +
                    ...
                    : '<span class="avatar-initial rounded-2 bg-label-' +
                      ...
                      (n = (
                        ((n =
                          (s = a.category_detail).match(/\b\w/g) ||
                          []).shift() || "") + (n.pop() || "")
                      ).toUpperCase()) +
                      "</span>") +
                  '</div></div><div class="d-flex flex-column justify-content-center"><span class="text-body text-wrap fw-medium">' +
                  s +
                  '</span><span class="text-muted text-truncate mb-0 d-none d-sm-block"><small>' +
                  r +
                  "</small></span></div></div>"
                );
              },
            },
            {
              ...
              render: function (e, t, a, o) {
                return (
                  '<div class="text-sm-end">' + a.total_products + "</div>"
                );
              },
            },
            {
